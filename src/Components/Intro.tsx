      ...
      <div className="z-10 max-w-screen-lg px-4 lg:px-0">
        <div className="flex flex-col items-center gap-y-6 rounded-xl bg-gray-800/40 p-6 text-center shadow-lg backdrop-blur-sm">
          ...
          <div className="flex-col-2 flex gap-x-4">
            ...
            />
            <Link
              className="m-auto flex gap-x-2 rounded-full border-2 border-orange-500 bg-none px-4 py-2 text-sm font-medium text-white ring-orange-500 ring-offset-gray-700/80 hover:bg-gray-700/80 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:text-base"
              to={resume}
              target="_blank"
              download
            >
